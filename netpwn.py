...
#Install tcpdump, rkhunter, chkrootkit, iftop, netdiscover and nmap for full functionality
...
options_sl = ['reverse_shell', 'packet_capture', 'port_scan', 'send_file', 'web_backdoor', 'vpn_server', 'rkhunter', 
    'chkrootkit', 'network_conns', 'hash_check', 'base64', 'discovery', 'address_info', 'modules']
...
def banner():
    ...
    print colored('     Type [help] shows help menu', 'green')
    print ' '
    print ' '
    print ' '
    print ' '
...
def help():
    ...
    print colored('[fix rkhunter] use this if rkhunter gives you warnings for everything', 'green')
